namespace RentApp.Migrations
{
    ...
    public partial class vehicleModelUpdate : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.PriceListItems", "UserId", "dbo.Vehicles", "Id", cascadeDelete: true);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PriceListItems", "UserId", "dbo.Vehicles");
